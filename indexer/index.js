...
, hostandport = '45.55.229.227:9200' //ES Server and Port 
...
function extractData(file) {
    ...
    exif(file, function(err, obj){
        ...
        } else 
        {
            ...
            if (typeof(searchObj.file_name) !== "undefined") {
                searchObj.file_name_search=obj["file name"].toLowerCase();
            }
            searchObj.directory=obj["directory"];
            searchObj.file_size=obj["file size"];
            searchObj.artist=obj["artist"];
            if (typeof(searchObj.artist) !== "undefined") {
                searchObj.artist_search=obj["artist"].toLowerCase();
            }
            searchObj.image_description=obj["image description"]; 
             
            if (typeof(searchObj.image_description) !== "undefined") {
                searchObj.image_description_search=obj["image description"].toLowerCase(); 
            }
            ...
            console.log("Creating the object "+JSON.stringify(searchObj, null, 4));
